...
<author> M. Kitsuregawa, H. Tanaka, and T. Moto-oka. </author> <title> Application of hash to data base machine and its architecture. </title> <container-title> New Generation Computing, </container-title> <volume> 1(1), </volume> <date> 1983. </date>
...
<author> W. H. Enright. </author> <title> Improving the efficiency of matrix operations in the numerical solution of stiff ordinary differential equations. </title> <container-title> ACM Trans. Math. Softw., </container-title> <volume> 4(2), </volume> <pages> 127-136, </pages> <date> June 1978. </date>
